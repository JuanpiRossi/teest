...
@Component({
  ...
  templateUrl: './parses-ilvl.component.html',
  styleUrls: ['./parses-ilvl.component.scss']
})
export class ParsesIlvlComponent implements OnInit {
    ...
    this.mongoService.getGuild({"guildName":"Untamed"})
      .subscribe(res => {
        ...
        this.rows.forEach(element => {
          ...
          element.heroicParse = {};
          element.normalParse = {};
          this.warcraftService.searchCharacterDpsIlvl(element.name,element.server)
            .subscribe(response =>  {
